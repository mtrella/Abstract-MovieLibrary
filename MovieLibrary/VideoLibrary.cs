            ...
            try
            {
                ...
                while (!sr.EndOfStream)
                {
                    ...
                    if (idx == -1)
                    {
                        ...
                        video.regions = videoDetails[4].Split('|').ToList();
                    }
                    else
                    {
                        ...
                        // replace the "|" with ", "
                        video.writers = line.Split('|').ToList();
                    }
                    Videos.Add(video);
                }
